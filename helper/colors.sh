...
# 0xSin Color Palette
# Primary accent: Clean Gray (replaces Cyan)
...
COLOR_BLUE="\e[34m"
COLOR_MAGENTA="\e[35m"
COLOR_CYAN="\e[37m"         # Remapped to clean light gray
...
COLOR_LIGHT_CYAN="\e[37m"   # Remapped to clean light gray
...
COLOR_BOLD_CYAN="\033[1;37m"    # Remapped to bold white/gray

# 0xSin accent: Clean Gray
COLOR_ACCENT="\033[1;37m"
COLOR_ACCENT_DIM="\e[37m"
